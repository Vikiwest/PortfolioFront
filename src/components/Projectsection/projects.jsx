...
const projectsData = [
  ...
  },
  {
    ...
    description: "A comprehensive business dashboard for monitoring platform activities, user management, and business analytics. Built with modern technologies for optimal performance and user experience.",
    image: Myxellia,
  ...
  },
  {
    id: 3,
    title: "Edu Manager",
    description: "A comprehensive educational management application for tracking student activities with dedicated dashboards for both administrators and students to monitor curricular activities.",
    image: EduManager,
  ...
  },
  {
    ...
    description: "A secure dashboard featuring user authentication, activity logging, and file upload functionality with modern UI/UX principles.",
    image: AuthApp,
  ...
  },
  {
    ...
    description: "A web-based weather application demonstrating API integration with global location search and comprehensive weather condition displays.",
    image: WeatherApp,
  ...
  },
  {
    ...
    description: "A responsive portfolio website with integrated contact functionality allowing direct email communication through the platform.",
    image: myPortfolio,
  ...
  },
  {
    ...
    description: "A responsive e-commerce website demo showcasing modern UI design principles and cross-device compatibility.",
    image: Bngoon,
  ...
  },
  {
    ...
    description: "A client website designed to establish authentic business presence and prevent impersonation with easy customer navigation and direct contact features.",
  ...
  },
  {
    ...
    description: "A fashion e-commerce platform showcasing available products with responsive design and intuitive user interface.",
    image: Tariq,
...
function Projects() {
  ...
  const ProjectCard = ({ project, index, isFeatured = false }) => {
    ...
    return (
      <div className={`group relative mb-20 ${isFeatured ? 'featured-project' : ''}`}>
        <div className={`m-auto w-[90%] lg:w-[85%] flex flex-col ${
            ...
            <div>
              ...
              {isFeatured && (
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="text-brandyellow text-sm font-semibold">Featured Project</span>
                </div>
              )}
              ...
              <p className="text-gray-300 text-lg leading-relaxed mb-6">
                {project.description}
                {project.company && (
                  <span className="block mt-2 text-brandyellow text-sm">
                    © {project.company}
                  </span>
                )}
              </p>
  ...
  return (
    <section id="projects" className="py-20 lg:py-32 text-white bg-gradient-to-b from-gray-900 to-black">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16 lg:mb-24">
          ...
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">
            A collection of my recent work showcasing full-stack development, modern UI/UX, and innovative solutions
          </p>
        </div>
