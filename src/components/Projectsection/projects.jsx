    ...
    <div id="projects" className="mt-[205px]">
      ...
      <div className="m-auto w-[90%] md:w-[70%] flex flex-wrap mt-20   ">
        ...
        <div className="w-full md:w-[666px] h-auto bg-OffWhite shadow-lg  rounded-r-3xl pt-10 pl-9 pr-9 pb-4 space-y-3">
          ...
          <p className="weather-app-desc text-grey text-[18px] leading-[px]">
            This is a simple fashion website for users to view displayed, available products for purchase. I built this web app using just Html
            and Css. It is mobile responsive and adjusts to all screen sizes.
          </p>
          <div className="mt-8 mb-5">
            <a
      ...
      <div className="m-auto w-[90%] md:w-[70%] flex flex-wrap mt-20  rounded-lg ">
        ...
        <div className="w-full md:w-[666px] h-auto bg-OffWhite shadow-lg  rounded-r-3xl pt-10 pl-9 pr-9 pb-4 space-y-3">
          ...
          <p className="weather-app-desc text-grey text-[18px] leading-[px]">
            ...
            to refine or adjust messages before sending them to someone.{" "} I worked closely with the design and product team including a backend developer to build thi responsive user interface.  <br /> <br /> ©️Monsieur Cruise LTD
          </p>
          <div className="mt-8 mb-5">
            <a
              href="https://www.sabitok.com"
              target="_blank"
            >
              <Viewprojbtn />
            </a>
